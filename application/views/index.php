<body>
    <div class="pre-loader">
        <div class="load-con">
            <img src="<?php echo base_url('asserts/img/eco/logo.png') ?>" class="animated fadeInDown" alt="">
            <div class="spinner">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4" >
                        <img src="<?php echo base_url('asserts/img/eco/iphone-eco.png') ?>" class="img-responsive scrollpoint sp-effect5" alt="">
                    </div>
        ...
        <section id="screens">
            <div class="container">
                ...
                <div class="slider filtering scrollpoint sp-effect5" >
                    <div class="one">
                        <img src="<?php echo base_url('asserts/img/eco/screens/profile.jpg') ?>" alt="">
                        <h4>Profile Page</h4>
                    </div>
                    <div class="two">
                        <img src="<?php echo base_url('asserts/img/eco/screens/menu.jpg') ?>" alt="">
                        <h4>Toggel Menu</h4>
                    </div>
                    <div class="three">
                        <img src="<?php echo base_url('asserts/img/eco/screens/weather.jpg') ?>" alt="">
                        <h4>Weather Forcast</h4>
                    </div>
                    <div class="one">
                        <img src="<?php echo base_url('asserts/img/eco/screens/signup.jpg') ?>" alt="">
                        <h4>Sales Analysis</h4>
                    </div>
                    <div class="one">
                        <img src="<?php echo base_url('asserts/img/eco/screens/calendar.jpg') ?>" alt="">
                        <h4>Event Calendar</h4>
                    </div>
                    <div class="two">
                        <img src="<?php echo base_url('asserts/img/eco/screens/options.jpg') ?>" alt="">
                        <h4>Some Options</h4>
                    </div>
                    <div class="three">
                        <img src="<?php echo base_url('asserts/img/eco/screens/sales.jpg') ?>" alt="">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="hanging-phone scrollpoint sp-effect2 hidden-xs">
                            <img src="<?php echo base_url('asserts/img/eco/eco-angled2.png') ?>" alt="">
                        </div>
                        <div class="platforms">
