    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                <li ><a href="<?php echo base_url('index.php/AdminPanel/listuser') ?>"><i class="fa-bullhorn fa"></i> User Manage</a></li>
                <li ><a href="<?php echo base_url('index.php/AdminPanel/listpaper') ?>"><i class="fa-bullhorn fa"></i> FullPaper Manage</a></li>
                <li><a href="<?php echo base_url('index.php/AdminPanel/listpayment') ?>"><i class="glyphicon glyphicon-cog"></i> Payment Manage</a></li>
